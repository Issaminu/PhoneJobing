window.onload = function () {
    window.AccTypeTeleButton = document.getElementById('AccTypeTeleButton').onclick = function () {
    ...
    window.AccTypeCommButton = document.getElementById('AccTypeCommButton').onclick = function () {

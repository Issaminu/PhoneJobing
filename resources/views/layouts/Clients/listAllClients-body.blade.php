<div class="input-group fmxw-300 " style="margin-left:69.8%">
    <input style="width:14rem; --tw-ring-color: rgb(75, 85, 99);" id="teamSearch" type="text" class="form-control"
                    ...
                    <tr style="text-align: center;">
                        ...
                        alt="Avatar"> --}}
                                <div class="d-block"><span
                                        class="fw-bold">{{ ucwords($client->name) }}</span>

                ...
                @auth
                    @if (Auth::user()->type === 'manager')
                        <a href="{{ url('/my-dashboard') }}"
                            class="text-sm text-gray-700 dark:text-gray-500 underline">Manager Dashboard</a>
                    @elseif (Auth::user()->type === 'teleoperateur')
                        <a href="{{ url('/my-dashboard') }}"
                            class="text-sm text-gray-700 dark:text-gray-500 underline">Teleoperateur Dashboard</a>
                    @elseif (Auth::user()->type === 'commercial')
                        <a href="{{ url('/my-dashboard') }}"
                            class="text-sm text-gray-700 dark:text-gray-500 underline">Commercial Dashboard</a>
                    @endif
                @else
